          ...
          <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12 mb-3">
                ...
                <input type="text" class="form-control form-control-sm @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $user->username) }}" required placeholder="اسم المستخدم">
                @error('username')
                  <div class="invalid-feedback text-xs">{{ $message }}</div>
                @enderror
              </div>
